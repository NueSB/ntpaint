            ...
            frag: `#version 300 es
                    ...
                    void main()
                    {
                        ...
                        switch(layerOperation)
                        {
                            ...
                            default:
                                outCol.rgb = mix( inCol.rgb, topCol.rgb, topCol.a * topAlpha );
                            break;
                        };

                        if (inCol.a < 0.001)
                        {
                            outCol = topCol * vec4(1.0, 1.0, 1.0, topAlpha);
                            return;
                        }

                        outCol.a = clamp(inCol.a + topCol.a * topAlpha, 0.0, 1.0);
            ...
            frag: ` #version 300 es
                    ...
                    void main()
                    {
                        ...
                        clomp = mix(clomp, 1.0-pow(
                            distance(vTexcoord.xy, vec2(0.5))*2.0, 0.3333), 
                            PROP_SOFT);
                        
                        clomp = mix(clomp, (clomp + (IGN(gl_FragCoord.xy) - 0.5) * 0.05 * (1.0-clomp)), PROP_SOFT);
